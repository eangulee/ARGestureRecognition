...
namespace Common.Tools.Editor
{
    ...
    {
        [ExecuteInEditMode]
        [MenuItem("Tools/CreateUIViewTemplate", false, 100)]
        public static void CreateUIViewTemplate()
        {
            ...
            boxCollider.size = new Vector3(2048, 1536, 1);
            ...
            bgCoreRectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, 1536);
            ...
            coreRectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, 1536);
            coreRectTransform.anchorMin = new Vector2(0, 0.5f);
            coreRectTransform.anchorMax = new Vector2(1, 0.5f);

            //uiViewTemplateGameObject.AddComponent<Logic.UI.BaseView>();
        }
    }
}
