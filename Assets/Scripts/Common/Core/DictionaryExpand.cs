...
public static class DictionaryExpand
{
    ...
    public static void SortedByValues<TKey, TValue>(this Dictionary<TKey, int> dic, SortType sortType = SortType.Asc)
    {
        Dictionary<TKey, int> temp = new Dictionary<TKey, int>(dic);
        dic.Clear();
        ...
        if (sortType == SortType.Asc)
        {
            ...
            {
                KeyValuePair<TKey, int> kvp = temp.MinValue<TKey,int>();
        ...
        else if (sortType == SortType.Desc)
        {
            for (int i = 0; i < count; i++)
            {
                KeyValuePair<TKey, int> kvp = temp.MaxValue<TKey, int>();
                dic.Add(kvp.Key, kvp.Value);
                temp.Remove(kvp.Key);
            }
        }
    ...
    public static Dictionary<TKey, TValue> TryAdd<TKey, TValue>(this Dictionary<TKey, TValue> dict, TKey key, TValue value)
    {
        ...
        else Debug.Log("already exsit key:" + key.ToString());
        return dict;
    }
    ...
    /// 获取字典中的最小值(byte)
    /// </summary>
    public static KeyValuePair<TKey, byte> MinValue<TKey, TValue>(this Dictionary<TKey, byte> dict)
    {
        //if(t==typeof(int))
        KeyValuePair<TKey, byte> result = default(KeyValuePair<TKey, byte>);
        if (dict.Values.Count > 0)
    ...
    /// 获取字典中的最小值(int)
    /// </summary>
    public static KeyValuePair<TKey, int> MinValue<TKey, TValue>(this Dictionary<TKey, int> dict)
    {
        //if(t==typeof(int))
        KeyValuePair<TKey, int> result = default(KeyValuePair<TKey, int>);
        if (dict.Values.Count > 0)
    ...
    /// 获取字典中的最小值的键值对
    /// </summary>
    public static KeyValuePair<TKey, uint> MinValue<TKey, TValue>(this Dictionary<TKey, uint> dict)
    {
        //if(t==typeof(int))
        KeyValuePair<TKey, uint> result = default(KeyValuePair<TKey, uint>);
        if (dict.Values.Count > 0)
    ...
    /// 获取字典中的最小值(float)
    /// </summary>
    public static KeyValuePair<TKey, float> MinValue<TKey, TValue>(this Dictionary<TKey, float> dict)
    {
        //if(t==typeof(int))
        KeyValuePair<TKey, float> result = default(KeyValuePair<TKey, float>);
        if (dict.Values.Count > 0)
